...
/* Criando uma lista unica com a soma da lista de Best sellers masculinos
 e Best sellers Femininos */  
const Items = BestM.concat(BestF);
/* Criando uma lista unica com a soma da lista de Best sellers masculinos
 e Best sellers Femininos */  


/* Função que adiciona cada item do Best Sellers masculinos
   no ID do HTML 'best-sellerM' */  
BestSellerM = () => {
...
/* Fim Função que adiciona cada item do Best Sellers masculinos
   no ID do HTML 'best-sellerM' */  


/* Função que adiciona cada item do Best Sellers femininos
   no ID do HTML 'best-sellerF' */  
BestSellerF = () => {
...
/* Fim Função que adiciona cada item do Best Sellers femininos
   no ID do HTML 'best-sellerF' */
...
/* Fim Função que verifica a chave "quantidade" de cada item
    e caso essa variavel seja superior que 0 adiciona uma Div 
    do Objeto para visualização */
